      ...
      <section id="about" className="relative z-10 py-24 px-6 lg:px-12 xl:px-20">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 mb-16">
            {[
              { icon: <GraduationCap className="w-8 h-8 text-accent mb-4" />, title: "Education", content: (<div className="space-y-2 text-white/50"><p className="font-semibold text-white">BSc in Computer Science</p><p className="text-sm">Haramaya University</p><p className="text-sm">2023 - Present</p><div className="flex items-center gap-2 mt-3"><Award className="w-4 h-4 text-accent" /><span className="font-mono text-accent text-sm">Web Dev & Cybersecurity</span></div></div>) },
