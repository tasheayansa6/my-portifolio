        ...
        <div className="max-w-7xl w-full flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="flex-1 text-center lg:text-left space-y-8">
            ...
            <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
              <a href="/TeshaleAyansa_Resume_v2.pdf" download="TeshaleAyansa_Resume_v2.pdf" className="flex items-center gap-2 px-6 py-3 bg-accent text-black font-semibold rounded-lg hover:bg-accent/80 transition-colors">
            ...
            <div className="relative w-64 h-64 lg:w-80 lg:h-80">
              ...
              <div className="w-full h-full rounded-full bg-gradient-to-tr from-accent to-white/20 p-[3px]">
                <div className="w-full h-full rounded-full overflow-hidden relative">
                  <Image src="/port/535c704d-3bc2-4dbf-acbe-8475057684de.jpg" alt="Teshale Ayansa" fill className="object-cover" quality={100} priority />
                </div>
              </div>
            </div>
